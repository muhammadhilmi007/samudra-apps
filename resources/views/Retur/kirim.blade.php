...
@section("content")
		...
		<div class="col-lg-4">
		  <div class="box box-primary">
		    <div class="box-header with-border">
		      <h3 class="box-title">Input Data Retur Kirim</h3>
		    </div>
		    <form method="POST">
		      <div class="box-body">
		      	  <div class="form-group">
		          	<label>STT</label>
		          	<select name="stt[]" required class="select2 form-control stt_form" multiple="true">
		          		<option value=""></option>
		          ...
		          <div class="form-group">
		          	...
		          	<input type="text" name="tanggal_kirim" class="form-control datetimepicker" required>
		          </div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="box box-primary">
			  <div class="box-header with-border">
			    <h3 class="box-title">STT Terkirim</h3>
			  </div>
			  <div class="box-body">
			  	 	...
			  	 	<tbody>
			  	 		@foreach($retur as $r)
				  	 		<tr>
					  	 		...
					  	 		<td>
					  	 			@if(!empty($r->tanggal_terima))
					  	 				<button type="button" class="btn btn-sm btn-info">SUCCESS</button>
					  	 			@else
