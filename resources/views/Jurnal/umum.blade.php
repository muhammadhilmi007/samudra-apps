...
<div class="box box-info">
    <div class="box-header with-border">
       ...
       <div class="box-body">
            <div class="row" ng-app="anJurnal">
                <div class="col-xs-12 main_container">
                    <div class="angular_controller" ng-controller="jurnal">
                        ...
                        <tbody>
                            <tr class="dynamic_input" ng-repeat="(x, y) in jurnalComponent">
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="text-align : right; padding-right: 20px;">[[chJumlahDebetRp]]</td>
                                <td style="text-align : right; padding-right: 20px;">[[chJumlahKreditRp]]</td>
                            </tr>
                            <tr>
                                <td colspan="9" style="text-align:left">
                                    <button class="btn btn-xs btn-success btn_add" ng-click="addJurnalComponent()"><i class="fa fa-plus"></i></button>
                                </td>
                            </tr>
                        </tbody>
                        </table>
...
@section("scripts")
    ...
    <script src="/js/jurnalumum.js"></script>
@stop