...
<div class="box box-info">
    <div class="box-header with-border">
       ...
       <div class="box-body">
            <div class="row" ng-app="anKasKecil">
                <div class="col-xs-12 main_container">
                    <div class="angular_controller" ng-controller="kaskecil">
                        ...
                        <tbody>
                            <tr class="dynamic_input" ng-repeat="(x, y) in kasKecilComponent">
                                <td>
                            ...
                            <tr>
                                <td colspan="9" style="text-align:left">
                                    <button class="btn btn-xs btn-success btn_add" ng-click="addKasKecilComponent()"><i class="fa fa-plus"></i></button>
                                </td>
                            </tr>
                        </tbody>
                        </table>
